...
class FSE_Header_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'show_navigation',
            [
                'label' => esc_html__('Show Navigation', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'fsetheme'),
                'label_off' => esc_html__('No', 'fsetheme'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_pagination',
            [
                'label' => esc_html__('Show Pagination', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'fsetheme'),
                'label_off' => esc_html__('No', 'fsetheme'),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Slider Settings', 'fsetheme'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'autoplay',
            [
                'label' => esc_html__('Autoplay', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'fsetheme'),
                'label_off' => esc_html__('No', 'fsetheme'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => esc_html__('Autoplay Speed', 'fsetheme'),
        ...
        $this->add_control(
            'slides_per_view',
            [
                'label' => esc_html__('Slides Per View', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 10,
                'step' => 1,
        ...
        $this->add_control(
            'space_between',
            [
                'label' => esc_html__('Space Between', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->add_control(
            'loop',
            [
                'label' => esc_html__('Infinite Loop', 'fsetheme'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'fsetheme'),
                'label_off' => esc_html__('No', 'fsetheme'),
                'return_value' => 'yes',
                    ...
                    <div class="swiper-wrapper">
                        <?php foreach ($settings['banner_slides'] as $slide): ?>
                            <div class="swiper-slide !h-full !flex items-center justify-center">
                                <img src="<?php echo esc_url($slide['banner_image']['url']); ?>" loading="lazy"
                                    alt="<?php echo esc_attr($slide['banner_alt']); ?>" height="30">
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <div
                        class="swiper-button-prev swiper-button-nav w800:invisible visible swiper-button-disabled swiper-button-lock">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                            role="img" class="icon text-xl" width="1em" height="1em" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M17.77 3.77L16 2L6 12l10 10l1.77-1.77L9.54 12z"></path>
                        </svg>
                    </div>
                    <div
                        class="swiper-button-next swiper-button-nav w800:invisible visible swiper-button-disabled swiper-button-lock">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                            role="img" class="icon text-xl" width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    jQuery(document).ready(function ($) {
                        if (typeof Swiper !== 'undefined') {
                            new Swiper('.swiper-container', {
                                ...
                                autoplay: <?php echo $settings['autoplay'] === 'yes' ? '{ delay: ' . esc_js($settings['autoplay_speed']) . ' }' : 'false'; ?>,
                                navigation: {
                    ...
                    <nav class="w-full flex-1 w800:h-full px-[10px] w800:px-[5px] flex justify-between items-center relative">
                        ...
                        <div class="flex-1 h-full flex items-center justify-end w800:justify-around">
                            ...
                            <div class="relative h-[35px] w800:h-[40px] w-fit mr-[5px] w500:mr-[10px] w800:mr-0">
                                <div
                                    class="btn-opacity text-[#fff] bg-[#ee374c] stroke-[#fff] shrink-0 w-fit h-full rounded-lg flex items-center pr-[5px] select-none cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        aria-hidden="true" role="img"
                                        class="icon text-[#fff] text-lg w800:text-xl mx-[2px] w800:mr-[5px]" width="1em"
                                        height="1em" viewBox="0 0 100 100">
                                    ...
                                    <div class="h-full flex flex-col justify-center">
                                        <div class="h-[14px] flex">
                                            <span
                                                class="text-[11px] inline-block"><?php echo esc_html($settings['location_title']); ?></span>
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                aria-hidden="true" role="img" class="icon text-sm" width="1em" height="1em"
                                                viewBox="0 0 24 24">
                            ...
                            <div class="h-[30px] w800:h-[35px] mx-[5px] flex-1 hidden w800:block max-w-[420px]">
                                <div class="h-full w600:relative">
                                    <form role="search" method="get" action=""
                                        class="h-full m-auto bg-[#fff] rounded-lg px-[10px] flex items-center relative transition-all">
                                        <label class="hidden" for="dtv-input__search1">Dtv search</label>
                                        <div class="w-[30px] h-[30px] flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                aria-hidden="true" role="img" class="icon text-xl stroke-1 shrink-0" width="1em"
                                        ...
                                        <input id="dtv-input__search1" name="s"
